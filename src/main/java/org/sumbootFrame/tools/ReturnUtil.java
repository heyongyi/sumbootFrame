...
public final class ReturnUtil {
    ...
    public static ReturnUtil REQUEST_METHOD_NO_AUTH = new ReturnUtil("00002", "request请求没有权限");
    public static ReturnUtil REQUEST_METHODFORMAT_NO_SUPPORT = new ReturnUtil("00004", "请求格式不正确");
    public static ReturnUtil REQUEST_METHODTYPE_NO_SUPPORT = new ReturnUtil("00003", "request请求类型不支持");
